...
?>
    ...
    <body>
        <div class="container">
            ...
            <form action="php/add-book.php" class="shadow p-4 rounded mt-5" style="width: 90%; max-width:50rem;" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="book_title" value="<?=$title;?>" class="form-control">
                </div>
                <div class="mb-3">
                    <label class="form-label">Book Description</label>
                    <input type="text" name="book_description"value="<?=$desc;?>" class="form-control">
                </div>
                <div class="mb-3">
