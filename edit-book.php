...
?>
    ...
    <body>
        <div class="container">
            ...
            <form action="php/edit-book.php" class="shadow p-4 rounded mt-5" style="width: 90%; max-width:50rem;" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="book_description"value="<?=$book['description'];?>" class="form-control">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="current_cover" value="<?=$book['cover'];?>" hidden  >
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="current_file" value="<?=$book['file'];?>" hidden >
